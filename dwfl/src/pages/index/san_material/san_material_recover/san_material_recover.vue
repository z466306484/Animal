        ...
        <div class="listbox">
          ...
          <div class="listbox_do">
            ...
            <div class="list_inputs">
              ...
              <!--按钮-->
              <el-button size="small " type="primary" @click="findmaterialre">查找</el-button>
            </div>
          </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        //表格传递参数
        tableobj:{
          tharr:[{width:'5%',val:'id'},{width:'22%',val:'资料名称'},{width:'7%',val:'所属分类'},{width:'10%',val:'是否推荐'},{width:'15%',val:'阅读/评论/收藏/点赞/分享'},{width:'8%',val:'状态'},{width:'13%',val:'发布时间'},{width:'20%',val:'操作'}],
          tabliearr:[],
          allarr:[],
        },
        //恢复弹框参数
    ...
    methods: {
      ...
      todetai(obj){
        if(obj.type==0){  //点击查看的方法
          this.$router.push({path:'/san_material_recover_show?type=2&&id='+obj.item.id})
        }
      ...
      alterdetai(obj){
        ...
        if(obj.type==0){
          ...
          //  发请求
          this.axios.post(this.apis+'/san/Material/delete', {
      ...
      alterredetai(obj){
        ...
        if(obj.type==0){
          ...
          //  发请求
          this.axios.post(this.apis+'/san/Material/reco', {
            article_id:this.rebackid,
          }).then((res) => {
            if(res.data.code==10000){
              this.$message({
                duration:1000,
