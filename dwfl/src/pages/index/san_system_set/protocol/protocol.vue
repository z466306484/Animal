      ...
      <div class="content" >
        <div class="listbox">
          ...
          <div class="add_manager">
            <div class="list">
              <div class="list_title"><p>标题</p></div>
              <div class="list_content">
                <el-input style="width: 100%;"  v-model="protocoltitle" placeholder="请填写标题"></el-input>
              </div>
            </div>
            <!--编辑器-->
            <div class="list">
  ...
  export default {
    ...
    methods: {
      ...
      submitForm() {
        //  发起请求
        let _this=this
        this.axios.post(this.apis+'/san/protocol/add', {
          title:_this.protocoltitle,
          protocol:_this.content,
        }).then((res) => {
      ...
      initdata(){
        let _this=this
        this.axios.post(this.apis+"/san/protocol/index")
          .then((res)=> {
            console.log(res.data)
            if(res.data.code==10000){
              _this.showpage = true
              _this.protocoltitle=res.data.data.title
              _this.content=res.data.data.protocol
            }
