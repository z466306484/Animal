        ...
        <div class="listbox">
          ...
          <div class="listbox_do">
            ...
            <div class="list_inputs">
              ...
              <!--按钮-->
              <el-button size="small" type="primary" @click="finduser">查找</el-button>
            </div>
          </div>
    ...
    methods: {
      ...
      todetai(obj){
        if(obj.type==0){  //点击查看的方法
          this.$router.push({path:'/san_user_show?type=1&&id='+obj.item.id})
        }
        if(obj.type==1){//点击编辑的方法
      ...
      alterdetai(obj){
        ...
        if(obj.type==0){
          ...
          //  发请求
          this.axios.post(this.apis+'/san/User/ajax_del', {
            id:this.deleteid,
          }).then((res) => {
      ...
      finduser(){
        ...
        this.roleshow()
        this.axios.post(this.apis+'/san/User/ajax_search', {
          ...
          if(res.data.code==10000){
           ...
           /* this.topInput=''
            ...
            for(var i=0;i<res.data.data.length;i++){
              ...
              my.btnarr=[{type:0,val:'查看'},{type:1,val:'禁用'}]
      ...
      initdata(){
        let _this=this
        this.axios.post(this.apis+"/san/User/ajax_show")
          .then((res)=> {
           if(res.data.code==10000){
